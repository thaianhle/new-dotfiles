...
- Fix incorrect javascript destructuring colors in certain conditions. [#203](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/203)
- Correctly highlight PHP semicolons when php expression is inside string. [#208](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/208)
- Fix issue preventing folded regions from receiving any highlight colors. [#210](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/210)
...
- Add secondary button styles. (closes [#176](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/176))

### Fix

- Remove preset contrast borders. (closes [#120](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/120), [#147](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/147))
- Improve contrast of "open a remote window" button. (closes [#146](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/146))

## 2.22.4

### Fix

- Address broken style property in html filetypes. [#177](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/177)

## 2.22.3

### Fix

- Fix another small issue impacting the build of the soft theme. [#165](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/165)

## 2.22.2

### Patch

- fix: address issue of black cursor in ipynb file for soft variant [#124](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/124)
...
- Add activitybar colors. [#121](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/121)

### Patch

- Fix cursor color in `ipynb` files. [#124](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/124)

## 2.18.1

### Patch

- Fix class keyword highlighting in babel syntax. [#118](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/118)
...
- Add support for `statusBarItem.remoteBackground` (currently available in insiders) [#105](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/105)
...
- Fix incorrect highlighting for variable names in JavaScript (and friends) in the body of default-exported classes/functions/etc. (#88, [#82](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/82))

## 2.14.1

### Patch

- Fix the incorrect syntax highlighting of "pseudo-constants" in `tsx` files. [#84](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/84)
...
- Add styling to the new breadcrumbs UI elements. [#85](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/85)

### Fix

- Fix the incorrect syntax highlighting of javascript/typescript "pseudo-constants" (a change that recently was added to the syntaxes). [#84](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/84)
...
- Fix color of editor rulers to match indent guides. [#79](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/79)
...
- Fix warning color decorations in the explorer. [#77](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/77)

## 2.10.0

- Add support for new highlighted indent guides. [#74](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/74)
...
- Implement improved ANSI colors for integrated terminal. [#66](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/66)
...
- Italicize html attribute names so that Operator Mono font users can have their fancy pseudo-cursive. [#62](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/62)
...
- Improve terminal white contrast. [#59](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/59)
...
- Change codelens from `orange` to `comment` color so it's less distracting. [#57](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/57)
...
**Notes:** Mac users should have a better experience with this one. Feel free to leave any critiques/comments on [#30](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/30) on github and we'll go from there.

## 2.1.2

### Patch

- Fix broken `OCaml` type highlighting. [#44](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/44)
...
- Fix extension install/update button color. [#43](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/43)
...
- Apply theme to notification panel. [#35](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/35)
- Apply theme to buttons.

### Patch

- Make colorization of python raw string literals more consistent. [#36](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/36)
- Switch from yellow to green for current highlight match to improve contrast over purple tokens. [#33](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/33)
...
- Add `Dracula Soft` theme variant (beta - comments/critiques welcomed). [#30](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/30)

### Patch

- Lighten ANSI `color0` and `color8` so that they're more legible in the terminal. [#32](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/32)
...
- Small adjustements to `findMatchHighlight` and `findRangeHighlight` in an attempt to improve contrast. [#31](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/31)
...
- Upgrade from experimental UI theme scopes (requires VSCode `v1.12.0`). [#28](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/28)
...
- Adjust TextMate scopes for strings so that VSCode "Expand Select" function works properly. Closes [#24](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/24) (HT: @ajitid)
...
- Fix status bar background color when there's no folder selected. Closes [#20](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/20) (HT: @23doors)
...
- Fix debug panel background color. Closes [#19](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/19) (HT: @23doors)
- Add contrast to the Activity Bar. (HT: @rajasimon)
- Adjust find match highlight to be differentiable from selection. Closes [#18](https://gitlab.com/mateuszdrewniak/dracula-dark-plus/-/issues/18) (HT: @nguyenhuumy)
